...
export class AiGenerationProcessorService {
  ...
  private noteWriterSystem() {
    return [
      ...
      'Consulta corrections como aprendizaje editorial reciente del cliente y evita repetir los patrones ya corregidos. Si una corrección histórica contradice el brief vigente, el comentario actual o una regla activa, prioriza estos últimos y no copies la corrección de forma mecánica.',
  ...
  private noteAuditSystem() {
    return [
      ...
      'Contrasta también corrections y bloquea la repetición de errores editoriales recientes del mismo cliente; una observación histórica no debe imponerse cuando contradiga el brief vigente, el comentario actual o una regla activa.',
